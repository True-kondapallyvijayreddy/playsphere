...
class TournamentLeaderboard {
  ...
  static TournamentLeaderboard from({
    ...
    final players = records.values
      ...
      // reached, then matches won, then fewest played (a player who won six
      // from six had a better tournament than one who won six from ten), and
      // finally name so the board is stable rather than arbitrary.
      ..sort((a, b) {
    ...
    return TournamentLeaderboard(players: players, groups: groups);
  }
